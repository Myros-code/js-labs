...
module.exports = class UserApi {
    ...
    getStartPage(){
        return this.getData(`${this.SERVER}?${this.PAGEOPTION}&${this.CHUNKOPTION}&${this.SEEDOPTION}`);
    }
    getUsersChunk(){
        return this.getData(`${this.SERVER}?${this.PAGEOPTION}&${this.RESOPTION}&${this.SEEDOPTION}`);
    }
